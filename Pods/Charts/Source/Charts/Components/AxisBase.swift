...
open class AxisBase: ComponentBase
{
    ...
    @objc open var labelFont = NSUIFont.systemFont(ofSize: 5)
    @objc open var labelTextColor = NSUIColor.gray
    ...
    // 격자 무늬 투명하게 만들어서 지워버려
    @objc open var gridColor = NSUIColor.gray.withAlphaComponent(0)
    @objc open var gridLineWidth = CGFloat(0)
