...
//  save your happiness
//
//  Created by 진윤수 on 2022/02/16.
//

import UIKit

class LanchLockViewController : UIViewController {
    var getPassword : [Int] = []
    let myPassword =  UserDefaults.standard.array(forKey: "passcode") as! [Int]
    ...
    @objc func zeroButtonTouch(){
        print(getPassword)
        print(myPassword)
        if getPassword.count < 4 {
            getPassword.append(0)
        }
    ...
    @objc func deleteButtonTouch(){
        let nowLength = getPassword.count
        if getPassword.count != 0{
            getPassword.removeLast()
            print(getPassword)
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            DeleteButton.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -60),
